...
const Projects = () => {
  ...
  // Listen for custom event to open new project modal
  useEffect(() => {
    const handleOpenNewProjectModal = () => {
      setIsNewProjectModalOpen(true);
    };
    
    window.addEventListener("open-new-project-modal", handleOpenNewProjectModal);
    
    return () => {
      window.removeEventListener("open-new-project-modal", handleOpenNewProjectModal);
    };
  }, []);
